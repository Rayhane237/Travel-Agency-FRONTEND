...
const FooterAbout = () => {
  return (
    <div>
        ...
        <div className='footer-container-book'>
              <div className='footer-item'>
                 ...
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Discover</h6>
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}  > About Us</h6>
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Contact</h6>
                </div>


             <div className='footer-item-book'>
                 <h5 style={{color:"rgba(255, 255, 255, 1)"}}>Our Activities</h5>
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Tour</h6>
             ...
             <div className='footer-item'>
                 ...
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Phone: 023 456 7890</h6>
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Email: phnes.travels@gmail.com </h6>
                 <h6 style={{color:"rgba(198, 199, 199, 1)"}}> Maps: Millennium City, Accra</h6>
             </div>
